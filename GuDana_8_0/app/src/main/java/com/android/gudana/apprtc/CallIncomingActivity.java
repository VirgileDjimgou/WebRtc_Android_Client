...
public class CallIncomingActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(user_id != null && room_id != null){
			ViCall = new Ringing_Vibrate_Manager(CallIncomingActivity.this.getApplicationContext());
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		/*
		if (Ringing_Vibrate_Manager.isInstanciated() && (keyCode == KeyEvent.KEYCODE_BACK || keyCode == KeyEvent.KEYCODE_HOME)) {
			Ringing_Vibrate_Manager.getLc().terminateCall(mCall);
			finish();
		}
		*/
