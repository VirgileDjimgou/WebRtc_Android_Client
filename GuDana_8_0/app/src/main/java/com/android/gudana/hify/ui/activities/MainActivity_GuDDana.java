...
import com.android.gudana.MoD.Tester_Live_Location_receiver_Activity;
import com.android.gudana.apprtc.linphone.Ringing_Vibrate_Manager;
...
import com.android.gudana.hify.ui.activities.settings.SettingsActivity;
...
public class MainActivity_GuDDana extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    // Attribut socket to share  gps

    private JSONObject info_gps;
    private Socket mSocket_gps_position_sharing;
    ...
    Ringing_Vibrate_Manager ViCall ;
    ...
    private class Init_after_OnCreate_Task extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            if (locationTrack.canGetLocation()) {
                ...
                // start gps location  service  sharing   ...
            ...
            if(currentuser!=null)
            {
                ...
                LocalBroadcastManager.getInstance(MainActivity_GuDDana.this).registerReceiver(mRegistrationBroadcastReceiver,
                        new IntentFilter(Config.REGISTRATION_COMPLETE));
    ...
    public void onItemSelected(int position) {
        ...
        switch (position) {
            ...
            case CHAT:
                ...
                Intent menuIntent = new Intent(MainActivity_GuDDana.this, SettingsActivity.class);
            ...
            case POS_SEND_FRIEND:
                ...
                Intent TestLive_location = new Intent(MainActivity_GuDDana.this, Tester_Live_Location_receiver_Activity.class);
                startActivity(TestLive_location);
