...
public class Tester_Live_Location_receiver_Activity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("");
        context = Tester_Live_Location_receiver_Activity.this;


        locationTrack = new LocationTrack(Tester_Live_Location_receiver_Activity.this);
        ...
        start_aharing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // test send message to room  to tell  you are joined the room

                try {
                    JSONObject location_object=new JSONObject();

                    location_object.put("Event", "GUDANA_LIVE_LOCATIONmaNBqAe3Htg5d7oZaPKZBIpk9Cy1");
                ...
                try {
                    Log.i("in timer", UID_EVENT_LOCATION_LIVE_CHANNEL+ "  in timer ++++  ");
                } catch (Exception e) {
                    e.printStackTrace();
                }

                //Intent LiveLocationSharing = new Intent(Tester_Live_Location_receiver_Activity.this , MoD_Live_Location_sharing_Activity.class);
                //startActivityForResult(LiveLocationSharing, ChatActivity.CodeLiveLocation);
                //Tester_Live_Location_receiver_Activity.this.finish();
        ...
        live_location = new live_location_sharing_db(Tester_Live_Location_receiver_Activity.this);
    ...
    public void InitSocketIo() throws  InterruptedException {
        ...
        try {
            ...
            info_gps_location.put("room_id", "GUDANA_LIVE_LOCATIONmaNBqAe3Htg5d7oZaPKZBIpk9Cy1");
    ...
    public void InitMarker_andUserInfos(){
        try {
            ...
            userHelper = new UserHelper(Tester_Live_Location_receiver_Activity.this);
            ...
            mFirestore.collection("Users")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            ...
                            Picasso.with(Tester_Live_Location_receiver_Activity.this).load(imag_link).into(target);
                        }
                    });
    ...
    protected synchronized void buildGoogleApiClient(){
        mGoogleApiClient = new GoogleApiClient.Builder(Tester_Live_Location_receiver_Activity.this)
