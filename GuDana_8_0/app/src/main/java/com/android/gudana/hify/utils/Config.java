...
public class Config {
    ...
    public  static  String Media_Server = "http://35.237.197.121".trim();
    ...
    public static  String FILE_UPLOAD_URL = Media_Server+"/AndroidFileUpload/fileUpload.php";

    public static  String IMAGES_UPLOAD_URL = Media_Server+"/AndroidFileUpload/Images_fileUpload.php";

    public static  String VIDEOS_UPLOAD_URL = Media_Server+"/AndroidFileUpload/Videos_fileUpload.php";
