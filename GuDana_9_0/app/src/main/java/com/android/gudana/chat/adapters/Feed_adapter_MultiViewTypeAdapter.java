 ...
 */
public class Feed_adapter_MultiViewTypeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Feed_adapter_MultiViewTypeAdapter(ArrayList<Model_message_chat> data, Context context) {
        this.dataSet = data;
